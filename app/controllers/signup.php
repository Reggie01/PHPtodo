<?php
    ...
    class SignUp extends Controller {
        ...
        public function post() {
            ...
            if ($have_error){
                return $this->render('templates/signup.html', ['error'=>$errors, 'username'=>$username, 'email'=>$email]);
            } else {
                echo 'passed';
                $todo = $this->model('User');
                $securepass = make_secure($password);
                $todo->createUser($username, $securepass);
                return $this->render('templates/welcome.html',['pagetitle'=>'Welcome']);
